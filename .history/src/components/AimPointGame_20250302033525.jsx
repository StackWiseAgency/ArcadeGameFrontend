...
const ReceiveMove_API= "https://arcadegamebackendapi20241227164011.azurewebsites.net/api/Webhook/GetLatestRfidData";
...
const AimPointGame = () => {
  ...
  useEffect(() => {
    const fetchGameData = async () => {
      try {
        const response = await axios.get("https://arcadegamebackendapi20241227164011.azurewebsites.net/api/Webhook/ClearRfidQueue");
        setGameData(response.data); // Store API data in state
      } catch (err) {
