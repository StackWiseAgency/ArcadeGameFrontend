...
const DiscArcadeModeGame = ({ navigateToSelection }) => {
  ...
  const API_RECEIVE_MOVE = "https://arcadegamebackendapi20241227164011.azurewebsites.net/api/Webhook/DummyResponseForReaders";
  ...
  }, [useApiInput, gameStarted, handleInputThrow]); // ✅ Only re-run when dependencies change
