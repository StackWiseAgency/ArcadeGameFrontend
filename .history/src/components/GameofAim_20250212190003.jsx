...
const GameofAim = () => {
  ...
  const renderResultScreen = () => (
    <div className="result-screen-aim">
      ...
      <p>Player 1 Letters: {gameResults?.player1?.letters || "None"}</p>  {/* ✅ Ensure it's always a string */}
      <p>Player 2 Score: {gameResults?.player2?.score}</p>
      <p>Player 2 Discs Left: {gameResults?.player2?.discsLeft}</p>
      <p>Player 2 Letters: {gameResults?.player2?.letters || "None"}</p>  {/* ✅ Ensure it's always a string */}
