...
import { notification, Card, Button, Typography } from "antd";
...
const GameofAim = () => {
  ...
  //   </div>
  // );
  const renderResultScreen = ({ winner, playAgain }) => (
    <div className="result-screen-aim">
      {/* Using Ant Design's Card component to display the result */}
      <Card
        title="Game Over"
        bordered={false}
      ...
      >
        ...
        <Text type="secondary">
          Congratulations to the winner! Thank you for playing.
        </Text>
        
        {/* Play Again Button */}
        <div style={{ marginTop: 20 }}>
          <Button type="primary" onClick={playAgain} style={{ width: '100%' }}>
            Play Again
          </Button>
        </div>
      </Card>
