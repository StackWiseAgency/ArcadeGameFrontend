...
const PaymentTran = ({ selectedGame, onClose }) => {
  ...
  console.log("✅ Selected Game Details:", selectedGame); // Debugging Log
  console.log("💰 Game Price:", selectedGame?.numericPrice); // Check if price is received correctly
  ...
  const handleCardPayment = async () => {
    ...
    const amount = selectedGame?.numericPrice ? selectedGame.numericPrice * 100 : 0; // Convert price to cents
    console.log(`💳 Processing Card Payment for: $${selectedGame.numericPrice}`); // Debugging Log
    ...
    try {
      ...
      console.log("🔑 Received Stripe Client Secret:", clientSecret); // Debugging Log
  ...
  const generateCheckoutQR = async () => {
    ...
    const amount = selectedGame?.numericPrice ? selectedGame.numericPrice * 100 : 0; // Convert price to cents
    console.log(`📱 Generating QR for: $${selectedGame.numericPrice}`); // Debugging Log
    ...
    try {
      ...
      console.log("🔗 Checkout URL:", url); // Debugging Log
      setCheckoutUrl(url);
