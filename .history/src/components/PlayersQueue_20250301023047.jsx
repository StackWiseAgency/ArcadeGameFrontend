...
const API_URL_Get_QUEUE = "https://arcadegamebackendapi20241227164011.azurewebsites.net/api/playersInQueue/GetAll";
...
const PlayersQueue = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    const fetchPlayers = async () => {
      try {
        const response = await fetch(API_URL_Get_QUEUE);
