...
const TicTacToeGame = ({ navigateToSelection }) => {
  ...
  const API_URL_Tic_Tac = "https://arcadegamebackendapi20241227164011.azurewebsites.net/api/GameSimulation/add"; // Replace with your actual API URL
  ...
  useEffect(() => {
    ...
    if (
      ...
      const results = {
        winner: "Game Draw! No more moves left!",
  ...
  const fetchAntennaDataFromAPI = useCallback(async () => {
    ...
    try {
      const response = await fetch(API_URL_Tic_Tac);
...
//       >
//         <Title level={2} className="winner-text">
...
//           <h3>Player 1 (A)</h3>
//           <p>Discs: {gameResults.playerA.discs}</p>
//           <p>Steals: {gameResults.playerA.steals}</p>
//           <p>Misses: {gameResults.playerA.misses}</p>

//           <h3>Player 2 (B)</h3>
//           <p>Discs: {gameResults.playerB.discs}</p>
//           <p>Steals: {gameResults.playerB.steals}</p>
//           <p>Misses: {gameResults.playerB.misses}</p>
//         </div>
//       </Card>
//     </div>
//   );
...
const ResultCard = ({ gameResults }) => {
  return (
    <div className="result-screen-container">
      ...
      >
        ...
        {/* Flexbox layout for player stats */}
  ...
  return (
    <div
      ...
      {gameEnded && gameResults && <ResultCard gameResults={gameResults} />}
      ...
      <h1 className="game-title">Tic-Tac-Clash</h1>
      ...
      <div className="scoreboard">
        ...
        <img src={gameRemote} alt="Game Remote" className="game-remote1" />
    </div>
  );
};
