  ...
  return (
    <div className="keyboard-container">
      ...
      <div className="keyboard">
        {/* Switch between default, shift, and specialChars layouts */}
        {renderKeys(shift ? layout.shift : layout.default)}
        {/* Uncomment the next line to show special characters layout */}
        {/* {renderKeys(shift ? layout.specialChars : layout.default)} */}
      </div>
    </div>
  );
};
