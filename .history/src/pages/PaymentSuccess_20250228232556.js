...
const PaymentSuccess = () => {
  ...
  useEffect(() => {
    ...
    if (encryptedData) {
      try {
        ...
        console.log("Decrypted Payment Data: ", encryptedData);
  ...
  const handleAddToQueue = async (data) => {
    ...
    try {
      const response = await axios.post('https://arcadegamebackendapi20241227164011.azurewebsites.net/api/playersInQueue/Add', {
        playerName,
        gameName,
        highScore,
        userId,
