...
const PaymentSuccess = () => {
  ...
  useEffect(() => {
    ...
    if (isDesktop) {
      console.log("🖥️ User is on a desktop. Starting countdown...");
  ...
  const handleAddToQueue = async (data) => {
    ...
    const playerName = data.playerName || guestName; // Default to "guest" if missing
  ...
  return (
    <div className="payment-status-container-success">
      ...
      <p>Thank you for your purchase. You have been added to queue!</p>
