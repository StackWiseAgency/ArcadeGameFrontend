...
import OnScreenKeyboard from "./OnScreenKeyboard"; // Import the OnScreenKeyboard component
...
const SigninPage = () => {
  ...
  const [inputValue, setInputValue] = useState(""); // This state is used to update input field values via the keyboard

  const handleChange = (input) => {
    setInputValue(input); // Update input value when keyboard input changes
  };

  const handleKeyPress = (button) => {
    console.log("Button pressed:", button); // Handle key press (e.g., for logging)
  };
  ...
  return (
    <div className="signin-container">
      ...
      {/* Place the OnScreenKeyboard below or inside the form container */}
      <OnScreenKeyboard
